(function() {
  ...
  function ready(error, datapoints) {
    ...
    svg.append("g")
      ...
      .attr("font-weight", 900) // Weirdly, I can chance the font properties of the axis in g
      .call(yAxis)
    // There is some custom styling going on down here:
      .select(".domain")
        .remove() // Removes the axis vertical line
    svg.selectAll(".tick:not(:first-of-type) line")
      ...
      .attr("stroke-dasharray", "1,7"); // Styling the ticks - dot size
    // And a nice little label to it!
    svg.append("text")
