(function() {
  ...
  // Domain will go from 1914 (when the Seleção was first assembled) to 2017
  ...
  var line = d3.line()
    .x(function(d) {
      return xPositionScale(d.years_on_team)
    })
    .y(function(d){
  ...
  function ready(error, datapoints) {
    ...
    svg.selectAll(".circle-in-the-end")
      ...
      .attr("cx", function(d){
        ...
        return xPositionScale(first.years_on_team) // And read the key 'year'
      })
      .attr("cy", function(d) {
        var first = d.values[d.values.length-1] // Gets the first object of nested array
    ...
    svg.selectAll(".text-labels")
      ...
      .attr("x", function(d) {
        ...
        return xPositionScale(first.years_on_team)
      })
      .attr("y", function(d) {
        var first = d.values[d.values.length-1]
        return yPositionScale(first.goals_total) 
...
// Finally, I need the X and Y axis.
    ...
    svg.append("text")
      ...
      .text("Years playing for the Seleção")
      .attr("x",width/2)
